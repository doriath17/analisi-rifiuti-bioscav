...
import com.doriath.model.AnagrafeAnalisi;
...
public class AnagrafeController extends ControllerBase {
    ...
    public void init(ControllerLoader loader, PrimaryController primaryController){
        ...
        AnagrafeAnalisi anagrafe = loader.getAnalisiDAO().getAnagrafeAnalisi();
        ...
        bindAnagrafe(anagrafe);
    }

    public void bindAnagrafe(AnagrafeAnalisi anagrafe){
        SimpleStringProperty dateA = anagrafe.get(AnagrafeItem.DATA_ANALISI);
        anagrafe.get(AnagrafeItem.DATA_ANALISI).addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                dateAnalisi.setValue(AnagrafeController.localDateStringConverter.fromString(dateA.getValue()));
            }
        });
        SimpleStringProperty dateB = anagrafe.get(AnagrafeItem.DATA_FORMULARIO);
        anagrafe.get(AnagrafeItem.DATA_FORMULARIO).addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
